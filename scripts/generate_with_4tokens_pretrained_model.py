...
from source.resources import DATASETS_DIR, REPO_DIR, RESOURCES_DIR
...
simplify_file(turkcorpus_complex_filepath, output_filepath, features_kwargs, 'model_4tokens')
